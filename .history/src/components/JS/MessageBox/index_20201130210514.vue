<template>
    <div class="messageBox">
        ...
        <p>({content})</p>
        <div>
            <div @touchstart="handle">{{cancel}}</div>
            <div>{{ok}}</div>
        </div>
    </div>
</template>
...
<style scoped>
.messageBox{width: 200px;height: 120px;border: 1px solid #ccc;border-radius: 4px; background: white;box-shadow: 3px 3px 3px 3px;position: absolute; left: 50%;top: 50%;margin: 60px 0 0 -100px;}
